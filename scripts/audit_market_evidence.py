"""Recompute features and product conservation from all private study-3 traces.
...
def main() -> None:
    ...
    sale_rows = []
    progress = Progress()
    with progress.stage("recompute_private_market_evidence"):
    ...
    write_json(root / "reports/market_integrity.json", result)
