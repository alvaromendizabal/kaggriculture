"""Run the frozen second study, preserving every completed game immediately."""
...
from kaggriculture_research.relationship_experiment import run_experiment
...
def main() -> None:
    ...
    progress = Progress()
    with progress.stage("resource_relationship_feature_research"):
